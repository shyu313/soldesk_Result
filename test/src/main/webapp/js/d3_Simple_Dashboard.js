function dashboard(id, fData){
    ...
    function legend(lD){
        ...
        var tr = legend.append("tbody").selectAll("td").data(lD).enter().append("td");


        // create the first column for each segment.
        // tbody의 tr의 첫번째td 감정색깔상자
        tr.append("g").append("svg").attr("width", '16').attr("height", '16').append("rect")
...
*/
        ...
        // tbody의 tr의 네번째td 감정 분포율
        tr.append("g").attr("class",'legendPerc')
        ...
        leg.update = function(nD){
            ...
            var l = legend.select("tbody").selectAll("td").data(nD);
    ...
    var sF2 = fData.map(function(d){return [d.State,d.total];});

    var leg = legend(tF),  // 범례 생성
         hG = histoGram(sF2), // 막대 그래프 생성
         pC = pieChart(tF); // 원형 그래프 생성
