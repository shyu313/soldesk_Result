...
<%@ include file ="../header.jsp" %>
    ...
    <div>
        ...
        <label id="currentMonth">January 2017</label>
    </div>
    ...
    <script type="text/javascript">
        ...
        var d3CalendarGlobals = function() {
            var calendarWidth = 760, 
            calendarHeight = 500,
            gridXTranslation = 5,
            gridYTranslation = 30,
            cellColorForCurrentMonth = '#AAAAAA',
            cellColorForPreviousMonth = '#333333',
        ...
        function renderCalendarGrid(month, year) {
            ...
            d3CalendarGlobals.datesGroup 
                 ...
                 .enter()
                 .append("text")
                 .attr("y", function (d, i) { return cellPositions[i][0]; })
                 .attr("x", function (d, i) { return cellPositions[i][1]; })
                 .attr("dy", 20) // right padding
                 .attr("dx", 20) // vertical alignment : middle
                 .attr("transform", "translate(" + d3CalendarGlobals.gridXTranslation + "," + d3CalendarGlobals.gridYTranslation + ")")
